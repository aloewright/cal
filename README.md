...
- E2E tests start a small local HTTP harness on port 8788 and verify the unauthenticated auth page plus logo/favicon asset aliases in desktop and mobile Chromium contexts.
